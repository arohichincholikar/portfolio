document.addEventListener('DOMContentLoaded', () => {
  ...
  if (checker && window.innerWidth > 700) {
...
const designPages = {
  ...
  "club-posters": {
    ...
    items: [
      { type:"project", id:"winterfest", title:"winter fest poster", image:"images/design/club/winterfest.png", imageFull:"images/design/club/winterfest.png"},
      { type:"project", id:"kathaa", title:"kathaa workshop poster", image:"images/design/club/kathaa.png", imageFull:"images/design/club/kathaa.png"},
      { type:"project", id:"concept", title:"event poster concept", image:"images/design/club/concept.png", imageFull:"images/design/club/concept.png"}
    ]
  },
  ...
  "ui-interfaces": {
    ...
    items: [
      { type:"project", id:"amazon", title:"amazon select- ux case study", image:"images/design/uiweb/amazon.png" },
      { type:"project", id:"clueless", title:"clueless - ux case study", image:"images/design/uiweb/clueless.png" },
      { type:"project", id:"keepsake", title:"keepsake - ui case study", image:"images/design/uiweb/keepsake.png"}
    ]
  },
  ...
  "archive-posters": {
    ...
    items: [
      { type:"project", id:"jeffbuckley", title:"jeff buckley poster", image:"images/design/archive/jeffbuckley.png", imageFull:"images/design/archive/jeffbuckley.png" }
    ]
  },
  ...
  page.items.forEach(item => {
    ...
    card.onclick = () => {
      if(item.type === "folder"){
        ...
        window.open(item.imageFull, "_blank");
      } else{
